...
> 최신 전국 데이터 기준 전처리·적재 상태는 [kr_nationwide_pipeline_report_20260628.md](kr_nationwide_pipeline_report_20260628.md)를 기준으로 한다.
> 이 문서는 2026-06-10 강원/경북 40개 도시 기준 과거 검증 기록으로 유지한다.
